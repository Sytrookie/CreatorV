...
local function colors()
    ...
    options[#options+1] = {
        ...
        close = true,
        args = {
            menu = 'client.vehiclemods.menus.paint',
            menuArgs = {
                true,
            }
        }
    ...
    options[#options+1] = {
        ...
        close = true,
        args = {
            menu = 'client.vehiclemods.menus.neon',
        }
    }

    options[#options+1] = require('client.vehiclemods.options.xenon')()
    options[#options+1] = require('client.vehiclemods.options.pearlescent')()
    options[#options+1] = require('client.vehiclemods.options.wheelcolor')()
    options[#options+1] = require('client.vehiclemods.options.windowtint')()
    options[#options+1] = require('client.vehiclemods.options.tyresmoke')()
    options[#options+1] = require('client.vehiclemods.options.interior')()

    local liveryOption = require('client.vehiclemods.options.livery')()
...
local function onSubmit(selected, scrollIndex, args)
    ...
    local success = require('client.vehiclemods.utils.installMod')(duplicate, 'colors', {
        description = desc,
