...
local lastIndex = 1
local WheelType = require('client.vehiclemods.utils.enums.WheelType')
...
local function wheels()
    ...
    for _, category in ipairs(VMODSConfig.Wheels) do
...
local function onSubmit(selected, scrollIndex)
    ...
    local success = require('client.vehiclemods.utils.installMod')(duplicate, 'cosmetic', {
